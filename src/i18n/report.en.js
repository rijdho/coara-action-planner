...
export const REPORT_EN = {
  ...
  footer:
    "Draft generated with Reform Action Planner (rijdho.github.io/coara-action-planner, DOI 10.5281/zenodo.21492548) from a self-assessment of the ten CoARA commitments. Edit freely before adoption.",
