...
// and record what was copied in src/house/house.lock.json. Never edit the copy: this project's own styles
// go in src/index.css, which src/main.jsx imports after it. tests/house.test.mjs enforces both.
